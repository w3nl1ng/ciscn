...
func IsHFishfHoneyPot(target string) bool {
	...
	if strings.Contains(bodyStr, "/w-logo-blue.png?ver=20131202") && strings.Contains(bodyStr, "?ver=5.2.2") && strings.Contains(bodyStr, "static/x.js") {
		return true
	}
